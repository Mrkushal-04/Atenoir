                ...
                <div className="container mx-auto px-6 py-16">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="flex items-center gap-3 mb-4">
                            <Calendar className="w-8 h-8 text-lime-yellow-600" />
                            <h1 className="text-3xl font-bold text-white">Stylist Booking</h1>
                        </div>
                        <p className="text-gray-300 mb-6">Book a session with our expert stylists. (Feature coming soon!)</p>
                        <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 flex flex-col items-center justify-center">
                            <span className="text-gray-500">[Stylist Booking Placeholder]</span>
                        </div>
                    </div>
                </div>
                <Footer />
