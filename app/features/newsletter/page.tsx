            ...
            <div className="relative z-10">
                ...
                <div className="container mx-auto px-6 py-16">
                    <div className="max-w-xl mx-auto">
                        ...
                        <h1 className="text-3xl font-bold text-white mb-6">Newsletter Subscription</h1>
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            <input className="w-full p-3 rounded-lg bg-gray-900 border border-gray-700 text-white" placeholder="Your Email" type="email" required />
