...
export default function MenProductsPage() {
    ...
    const filteredProducts = useMemo(() => {
        ...
        return filtered
    }, [menProducts, searchQuery, sortBy, priceRange, selectedColors, selectedSizes, selectedSubcategories])

    // Get unique values for filters
    const allColors = Array.from(new Set(menProducts.flatMap(p => p.colors.map(c => c.name))))
    const allSizes = Array.from(new Set(menProducts.flatMap(p => p.sizes)))
    const allSubcategories = Array.from(new Set(menProducts.map(p => p.subcategory)))
        ...
        <div className="min-h-screen bg-black/[0.96] text-white">
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="mb-12">
                    ...
                    >
                        Discover our premium collection of men's clothing and accessories
                    </motion.p>
                </div>
