...
export default function AllProductsPage() {
    ...
    const filteredProducts = useMemo(() => {
        let filtered = products.filter(product => {
            ...
            return matchesSearch && matchesPrice && matchesColor && matchesSize && matchesCategory && matchesSubcategory
        })
        ...
        return filtered
    }, [products, searchQuery, sortBy, priceRange, selectedColors, selectedSizes, selectedCategories, selectedSubcategories])
