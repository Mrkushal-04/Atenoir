...
export default function WomenProductsPage() {
    ...
    const filteredProducts = useMemo(() => {
        ...
        return filtered
    }, [womenProducts, searchQuery, sortBy, priceRange, selectedColors, selectedSizes, selectedSubcategories])

    // Get unique values for filters
    const allColors = Array.from(new Set(womenProducts.flatMap(p => p.colors.map(c => c.name))))
    const allSizes = Array.from(new Set(womenProducts.flatMap(p => p.sizes)))
    const allSubcategories = Array.from(new Set(womenProducts.map(p => p.subcategory)))
        ...
        <div className="min-h-screen bg-black/[0.96] text-white">
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="mb-12">
                    ...
                    >
                        Discover our elegant collection of women's clothing and accessories
                    </motion.p>
                </div>
