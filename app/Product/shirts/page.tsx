...
export default function ShirtsPage() {
    ...
    const shirtProducts = getProductsBySubcategory("shirts")

    // Filter and sort products
    const filteredProducts = useMemo(() => {
        let filtered = shirtProducts.filter(product => {
        ...
        return filtered
    }, [shirtProducts, searchQuery, sortBy, priceRange, selectedColors, selectedSizes, selectedCategories])

    // Get unique values for filters
    const allColors = Array.from(new Set(shirtProducts.flatMap(p => p.colors.map(c => c.name))))
    const allSizes = Array.from(new Set(shirtProducts.flatMap(p => p.sizes)))
    const allCategories = Array.from(new Set(shirtProducts.map(p => p.category)))
        ...
        <div className="min-h-screen bg-black/[0.96] text-white">
            <div className="container mx-auto px-6 py-16">
                ...
                <div className="mb-12">
                    ...
                    >
                        Discover our premium collection of shirts for men, women, and kids
                    </motion.p>
                </div>
                    ...
                    <div className="flex-1">
                        <div className="mb-6">
                            <p className="text-gray-400">
                                Showing {filteredProducts.length} of {shirtProducts.length} shirts
                            </p>
                        </div>
                        ...
                        {filteredProducts.length === 0 && (
                            <div className="text-center py-16">
                                ...
                                <h3 className="text-xl font-semibold mb-2">No shirts found</h3>
